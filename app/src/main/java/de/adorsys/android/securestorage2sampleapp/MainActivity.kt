...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        button_store.setOnClickListener {
            if (edit_text_store_key.text.isNullOrEmpty() || edit_text_store_value.text.isNullOrEmpty()) {
        ...
        button_get.setOnClickListener {
            if (edit_text_get_key.text.isNullOrEmpty()) {
                Toast.makeText(this@MainActivity, "Field cannot be empty", Toast.LENGTH_SHORT).show()
            } else {
                val decryptedData =
                    SecureStorage.getString(this@MainActivity, edit_text_get_key.text.toString(), "FAILED")
                text_view_retrieved_data.text =
        ...
        button_remove.setOnClickListener {
            if (edit_text_remove_key.text.isNullOrEmpty()) {
                Toast.makeText(this@MainActivity, "Field cannot be empty", Toast.LENGTH_SHORT).show()
            } else {
